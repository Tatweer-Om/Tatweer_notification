...
@section('main')
    @push('title')
        <title> {{ trans('messages.subscription_exp', [], session('locale')) }}</title>
    @endpush
    ...
    <div class="main-content">
        ...
        <div class="page-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">{{ trans('messages.subscription_exp', [], session('locale')) }}</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a
                                            href="javascript: void(0);">{{ trans('messages.subscription_exp', [], session('locale')) }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">
                                        {{ trans('messages.subscription_exp_list', [], session('locale')) }}</li>
                                </ol>
                            </div>
            ...
            <div class="table-responsive mb-4">
                <table class="table align-middle datatable dt-responsive table-check nowrap " id="all_subscription_exp" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                    <thead>
                        <tr>
